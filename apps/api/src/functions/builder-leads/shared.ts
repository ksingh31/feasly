/**
 * Shared dispatch for the builder-leads Functions adapters (embed/09).
 *
 * All endpoints require a valid builder session (BuilderGuard). Tenant
...
export async function dispatchBuilderLeads(
  ...
  // All builder-leads endpoints require a valid builder session.
  try {
