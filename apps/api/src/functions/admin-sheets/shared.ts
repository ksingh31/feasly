/**
 * Shared dispatch for the admin Sheets-sync ops adapters (admin/05).
 *
 * Follows the api-keys/admin-leads adapter pattern: CORS at the edge,
 ...
 * AdminGuard (admin/01); audit logging for the manual trigger happens in
 * the route.
 */
...
export async function dispatchAdminSheets(
