  ...
  copy: {
    ...
    admin: {
      apiKeys: {
        ...
        issueTitle: 'Issue a new API key',
        nameLabel: 'Name',
        namePlaceholder: 'e.g. Elite Craft production',
        tenantLabel: 'Tenant ID (optional)',
        tenantPlaceholder: 'e.g. elite-craft',
        scopesLabel: 'Scopes',
        rateLimitLabel: 'Rate limit (per minute)',
        sandboxLabel: 'Sandbox key',
        sandboxHint: 'Sandbox keys are prefixed feasly_test_ and never billed.',
        createButton: 'Create key',
        cancelButton: 'Cancel',
        copyButton: 'Copy',
        copiedButton: 'Copied',
        plaintextWarning: 'Copy this key now — it will never be shown again.',
        rotateButton: 'Rotate',
        revokeButton: 'Revoke',
        rotateConfirm: 'Rotate this key? The old key stops working immediately.',
        revokeConfirm: 'Revoke this key? This cannot be undone.',
        confirmYes: 'Yes, continue',
        confirmNo: 'Cancel',
        editButton: 'Edit',
        saveButton: 'Save',
        usageTitle: 'Usage (per day by endpoint)',
        usageLoading: 'Loading usage…',
        usageEmpty: 'No usage recorded yet.',
        usageDateHeader: 'Date',
        usageEndpointHeader: 'Endpoint',
        usageRequestsHeader: 'Requests',
        usageEstimatesHeader: 'Estimates',
        loading: 'Loading keys…',
        empty: 'No API keys yet. Issue the first one above.',
        loadError: 'Couldn’t load API keys. Check the admin key configuration and try again.',
