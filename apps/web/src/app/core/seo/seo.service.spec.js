...
describe('SeoService', () => {
    ...
    it('sets title, description, OG tags, and canonical', () => {
        ...
        expect(TestBed.inject(Meta).getTag('name="description"')?.content).toBe('A test page description.');
        expect(TestBed.inject(Meta).getTag('property="og:url"')?.content).toBe('https://feasly.com/test');
